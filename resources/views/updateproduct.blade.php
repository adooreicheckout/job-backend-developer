...
<body>
        ...
        <div class="row">
            <div class="offset-3 col-6">
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form id="formupdate" name="formupdate" action="">
                            ...
                            <button class="btn btn-primary mb-3" id="enviar" name="enviar" type="submit"
                                onclick="updateProduct()">Update</button><br>
    ...
    <script>
        window.onload = function(){
            getByIdProduct(getParams()); 

        }
        function getParams() {
            var myParam = window.location.search.substring(4, location.search.length );
            console.log(myParam);
            return myParam;
        }
